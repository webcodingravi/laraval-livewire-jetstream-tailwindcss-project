    ...
    <main class="flex-1 overflow-y-auto p-4 md:p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
            ...
            <button wire:click="openModal"
                class="w-full sm:w-auto px-6 py-2bg-gradient-to-br from-[#24bad8] to-[#0b7a93] rounded active:scale-95 duration-300 text-white transition-all flex items-center justify-center gap-2 ">
                            ...
                            <div class="grid grid-cols-5 gap-2 bg-slate-100 p-4">
                                ...
                                <div>
                                    ...
                                    <button type="button" wire:click="addProductSize"
                                        class="px-6 py-4 bg-gradient-to-br from-[#24bad8] to-[#0b7a93] rounded active:scale-95 duration-300 text-white transition-all mt-6">+Add</button>
                                </div>
                            </div>
