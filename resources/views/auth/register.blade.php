<div>
    <div class="py-[120px]">
        <div class="flex justify-center items-center md:h-screen md:w-5/12 mx-auto flex-col gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-10 w-full mt-[50px]">
                ...
                <form wire:submit.prevent="register" method="post" class="space-y-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" wire:model.live.debounce.500ms="first_name"
                                    ...
                                    class="w-full pl-12 pr-4 py-3 border-2 {{ $errors->has('first_name') ? 'border-rose-500' : 'border-gray-200' }} rounded-lg focus:outline-none focus:border-indigo-600 transition bg-gray-50 focus:bg-white">
                            </div>
                            @error('name')
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" wire:model.debounce.500ms="last_name"
                                    ...
                                    class="w-full pl-12 pr-4 py-3 border-2 {{ $errors->has('last_name') ? 'border-rose-500' : 'border-gray-200' }} rounded-lg focus:outline-none focus:border-indigo-600 transition bg-gray-50 focus:bg-white">
                            </div>
                            @error('last_name')
                                <p class="mt-2 text-sm text-rose-600 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" wire:model.live.debounce.500ms="password" placeholder="••••••••"
                                id="password"
                                class="w-full pl-12 {{ $errors->has('password') ? 'border-rose-500' : 'border-gray-200' }} pr-12 py-3 border-2  rounded-lg focus:outline-none focus:border-indigo-600 transition bg-gray-50 focus:bg-white">
                    ...
                    <div class="flex items-start gap-3 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                        ...
                        <label for="terms" class="text-sm text-gray-700 cursor-pointer">
                            I agree to the <a href="#"
                                class="text-indigo-600 hover:text-indigo-700 font-semibold">Terms of
                                Service</a>
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        wire:loading.class="opacity-50 cursor-not-allowd" wire:target="register"
