                ...
                <div
                    ...
                    <div class="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="px-3 py-1 bg-rose-500 text-white text-xs font-bold rounded-full">HOT</span>
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
                            <img src="{{ asset('assets/img/category/product-1.png') }}"
                                class="w-full h-full object-contain cursor-pointer">
                        </div>
                    </div>
                    <div class="p-6">
                        <p class="text-xs font-semibold text-indigo-600 mb-2 tracking-widest">ELECTRONICS</p>
